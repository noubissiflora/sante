...
class PharmaciesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'responsible_1' => ['type' => 'string', 'length' => 255, 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        'responsible_2' => ['type' => 'string', 'length' => 255, 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public $records = [
        [
            ...
            'responsible_1' => 'Lorem ipsum dolor sit amet',
            'responsible_2' => 'Lorem ipsum dolor sit amet',
            'created' => '2017-01-27 16:28:24',
            'modified' => '2017-01-27 16:28:24'
        ],
    ];
}
