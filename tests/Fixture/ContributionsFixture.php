...
class ContributionsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'contributions_ibfk_1' => ['type' => 'foreign', 'columns' => ['patient_id'], 'references' => ['patients', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
    ...
    public $records = [
        [
            ...
            'created' => '2017-01-27 16:29:43',
            'modified' => '2017-01-27 16:29:43'
        ],
    ];
}
