...
class ContributionsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            ...
            'command_key' => ['type' => 'index', 'columns' => ['command_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'contributions_ibfk_1' => ['type' => 'foreign', 'columns' => ['user_id'], 'references' => ['users', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
            'contributions_ibfk_2' => ['type' => 'foreign', 'columns' => ['command_id'], 'references' => ['commands', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public $records = [
        [
            ...
            'created' => '2017-02-06 15:12:08',
            'modified' => '2017-02-06 15:12:08'
        ],
    ];
}
